  ...
  return (
    <div className="flex flex-col min-h-screen pt-28 pb-20">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            {categories.map((cat, idx) => (
              <div
                key={idx}
                className="p-4 rounded-2xl bg-secondary/30 border border-border/50 text-center font-semibold text-primary text-sm"
              >
                {cat}
              </div>
            ))}
        ...
        <div className="p-8 rounded-3xl bg-white border border-border/50 text-center max-w-2xl mx-auto shadow-sm">
