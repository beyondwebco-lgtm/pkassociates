        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-6">
          <div className="max-w-2xl">
            <motion.h2 
              ...
              viewport={{ once: true }}
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading font-bold mb-4 sm:mb-6 text-white break-words"
            >
          ...
          >
            <Link href="/uk-outsourcing" className="w-full md:w-auto">
              <Button className="w-full md:w-auto bg-accent text-accent-foreground hover:bg-accent/90 h-12 px-6 font-semibold">
          ...
          {ukOutsourcing.services.slice(0, 6).map((service, index) => (
            ...
            >
              <Link href={`/uk-outsourcing/${service.id}`} className="block h-full group">
                <div className="h-full p-6 sm:p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 flex flex-col">
