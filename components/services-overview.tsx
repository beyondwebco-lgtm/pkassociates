    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          >
            <Link href="/services">
              <Button variant="outline" className="h-12 px-6 border-primary/20 hover:bg-primary/5">
          ...
          {indiaServices.services.slice(0, 6).map((service, index) => (
            ...
            >
              <Link href={`/services/${service.id}`} className="block h-full group">
                <div className="h-full p-8 rounded-3xl bg-secondary/20 border hover:border-accent/50 hover:shadow-xl transition-all duration-300 flex flex-col">
