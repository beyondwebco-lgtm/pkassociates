    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-primary-foreground font-bold font-heading text-xl group-hover:bg-accent transition-colors">
            PK
          </div>
          <span className={`font-heading font-bold text-xl tracking-tight ${isScrolled || pathname !== '/' ? 'text-foreground' : 'text-primary'}`}>
            & Associates
          </span>
        </Link>
